...
//					 }
					...
					for (int kk = 0; kk < numOfTruck; kk++) {
						...
						if (totalPathCost - pik < -FUZZ) { // add this path as column of BMP, and update check to true
